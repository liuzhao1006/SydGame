...
PlayScene::PlayScene() : Scene() {
    mOurShader = nullptr;
    mTrivialShader = nullptr;
    mTextRenderer = nullptr;
    mShapeRenderer = nullptr;
     ...
     */
    const char *savePath = "/mnt/sdcard/com.sydauto.game.fix";
...
static unsigned char *gen_wall_texture() {
...
static void get_obs_color(int style, float *r, float *g, float *b) {
